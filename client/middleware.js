  ...
  if (accept.includes('text/markdown') || accept.includes('text/x-markdown')) {
    return new Response(MARKDOWN_CONTENT, {
      ...
      headers: {
        ...
        'Link': '</llms.txt>; rel="describedby"; type="text/markdown", </openapi.json>; rel="service-desc"; type="application/json", </.well-known/api-catalog>; rel="api-catalog"; type="application/linkset+json", </.well-known/agent-skills/index.json>; rel="agent-skills"; type="application/json", </.well-known/ap2>; rel="payment-protocol"; type="application/json", </.well-known/acp>; rel="commerce-protocol"; type="application/json", </.well-known/mcp/server-card.json>; rel="mcp-server"; type="application/json", </.well-known/oauth-authorization-server>; rel="oauth-authorization-server"; type="application/json", </.well-known/x402-mesh.json>; rel="x402-mesh"; type="application/json", </x402>; rel="payment"; type="application/json", </sitemap.xml>; rel="sitemap"; type="application/xml"'
      }
    });
  }
}
