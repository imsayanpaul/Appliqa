                    ...
                    <div className="lg:col-span-7 bg-[#F45B25] p-8 sm:p-12 md:p-14 text-white flex flex-col justify-between relative h-full">
                        ...
                        <div className="w-full">
                            <form onSubmit={handleSearch} className="w-full flex items-center bg-white rounded-2xl p-1.5 shadow-xl border border-white/20 transition-all focus-within:ring-2 focus-within:ring-white">
                                <div className="flex items-center pl-3.5 pr-2 flex-1 min-w-0">
                                ...
                                <div className="flex items-center gap-1.5 shrink-0">
                                    <button
                                        ...
                                        className={`px-3 py-2 rounded-xl text-xs font-bold transition-all border-none cursor-pointer flex items-center gap-1.5 whitespace-nowrap ${aiMode
                                    ...
                                    <button
                                        type="submit"
                                        disabled={loading}
                                        className="px-4 sm:px-5 py-2.5 rounded-xl bg-[#171717] hover:bg-neutral-900 text-white text-xs font-bold transition-all border-none cursor-pointer flex items-center gap-1.5 shadow-md disabled:opacity-50 whitespace-nowrap"
                                    >
